...
public class ScreensController extends GridPane {
    ...
    public boolean loadScreen(ControlledScreen controlledScreen) {
        try {
            controlledScreen.setScreenParent(this);
            addScreen(controlledScreen.toString(), (Node) controlledScreen);
            return true;
        } catch (Exception e) {
            System.out.println(e.getMessage());
            return false;
